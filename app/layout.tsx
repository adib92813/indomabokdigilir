...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://indomabokdigilir.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "logo": "https://indomabokdigilir.pages.dev/favicon.ico",
        "url": "https://indomabokdigilir.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://indomabokdigilir.pages.dev"
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://indomabokdigilir.pages.dev/?q={search_term}", 
